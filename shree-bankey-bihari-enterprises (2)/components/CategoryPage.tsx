...
const CategoryPage: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="pt-32 text-center serif text-xl">Loading category...</div>
    );
  }
    ...
    <div className="pt-32 md:pt-40 pb-24 md:pb-32">
      ...
      <section className="px-4 md:px-6 max-w-7xl mx-auto mb-16 md:mb-24">
        ...
        <div className="border-b border-[#4a3728]/10 pb-8 md:pb-12">
          ...
          <p className="text-[#4a3728]/60 text-sm md:text-lg max-w-3xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10 lg:gap-12">
          {products.map((product) => (
            ...
            >
              ...
              <p className="text-[#4a3728]/60 text-xs md:text-sm line-clamp-2">
                {product.description}
              </p>
            </div>
          ))}
